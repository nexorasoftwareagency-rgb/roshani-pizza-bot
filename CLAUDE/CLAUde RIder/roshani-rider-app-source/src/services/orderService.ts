...
export async function acceptOrder(params: {
  ...
  const { outlet, orderId, riderEmail, riderUid, riderPhone, riderName, riderLat, riderLng, outletLat, outletLng, customerPhone } =
    params;

  assertProximity(riderLat, riderLng, outletLat, outletLng, PROXIMITY.PICKUP_RADIUS_KM);
...
export async function markReachedOutlet(params: {
  ...
  const { outlet, orderId, riderLat, riderLng, outletLat, outletLng } = params;
  assertProximity(riderLat, riderLng, outletLat, outletLng, PROXIMITY.PICKUP_RADIUS_KM);
...
export async function confirmPickup(params: {
  ...
  const { outlet, orderId, riderLat, riderLng, outletLat, outletLng, riderPhone, customerPhone } = params;
  assertProximity(riderLat, riderLng, outletLat, outletLng, PROXIMITY.PICKUP_RADIUS_KM);
