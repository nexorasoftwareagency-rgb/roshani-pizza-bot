...
const SHARED_NODES = ["admins", "admins_list", "riders", "logs", "errorLogs", "bot", "migrationStatus", "riderStats", "settlements"];
...
/** Ghost-order filtering window — same defensive window used in FoodHubbie's port. */
